...
function gem_prox_qrqc_app_shortcode() {
    ...
    <div class="gemini-qrqc-app-container">
        ...
        <section id="analysis-section" class="qrqc-section hidden">
            ...
            <!-- Boutons de sauvegarde et de génération -->
            <div class="flex space-x-2 mt-4">
                <button id="save-discussion-btn" class="btn-secondary-outline w-1/2">
                    💾 Sauvegarder la discussion
                </button>
                <button id="generate-report-btn" class="btn-secondary w-1/2 hidden">
